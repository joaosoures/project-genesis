-- Atualizar aulas_stats para usar materiais como fonte de "aulas"
CREATE OR REPLACE FUNCTION public.aulas_stats()
 RETURNS TABLE(aula_id uuid, nome text, especialidade especialidade, total bigint, abcde bigint, lacuna bigint, oq_falta bigint)
 LANGUAGE sql
